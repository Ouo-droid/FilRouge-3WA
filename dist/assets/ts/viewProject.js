        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    showLoading(true);
                    hideError();
                    return [4 /*yield*/, Api.loadProjectsFromApi()];
                case 1:
                    data = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, 3, 4]);
                    showLoading(true);
                    return [4 /*yield*/, Api.loadProjectFromApi(String(projectId))];
                case 1:
                    data = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, Api.deleteProjectFromApi(String(projectId))];
                case 2:
                    result = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    showLoading(true);
                    return [4 /*yield*/, Api.editProjectFromApi(updatedProject)];
                case 2:
                    result = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, 4, 5]);
                    showLoading(true);
                    return [4 /*yield*/, Api.addProjectFromApi(newProject)];
                case 2:
                    result = _a.sent();
                    if (newProject) {
                        document.body.removeChild(formOverlay);
...
document.addEventListener("DOMContentLoaded", function () {
    // Ajouter un bouton pour créer un nouveau projet
...
// Export pour une éventuelle utilisation dans d'autres modules
